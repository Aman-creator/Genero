...
LET idx =1
    START REPORT order_list
        ...
        FOR i=1 TO arr1.getLength()
            LET order_rep.* = arr1[idx].*
...
LET description = getdescription2(stock_num)
LET fac_name   = getfactoryname2(fac_code)
LET store_name = getstorename2(store_num)
...
FUNCTION getfactoryname2(fac_code)
...
FUNCTION  getstorename2(store_num)
...
FUNCTION getdescription2(stock_num)
